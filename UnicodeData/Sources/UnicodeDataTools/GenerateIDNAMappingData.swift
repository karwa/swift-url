...
public func generateIDNAMappingData() throws -> String {
  ...
  let (db, replacements) = createIDNAMappingDatabase(dataFileContents: mappingTable)
...
func createIDNAMappingDatabase(
  dataFileContents: String
) -> (CodePointDatabase<IDNAMappingData>, ReplacementsTable.Builder) {
