...
extension OldURLParser.Host: Equatable, Hashable, CustomStringConvertible {
...
extension OldURLParser.Host: Codable {
...
func fake_domain2ascii(_ domain: inout [UInt8]) -> OldURLParser.Host.ValidationError? {
