extension Collection {
    ...
    /// Returns the longest subrange matching the given predicate.
    ///
    ...
    ///
    @inlinable
    public func longestSubrange(matching predicate: (Element) throws -> Bool) rethrows -> (subrange: Range<Index>, length: Int) {
        var idx = startIndex
