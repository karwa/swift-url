...
///
@usableFromInline
internal struct ASCIIMappingEntry {
  ...
  internal static var valid: Self {
    ASCIIMappingEntry(_storage: 0x00_00)
  }

  @inlinable
  internal static var disallowed_STD3_valid: Self {
    ASCIIMappingEntry(_storage: 0x01_00)
  }

  @inlinable
  internal static func mapped(to replacement: UInt8) -> Self {
    ASCIIMappingEntry(_storage: 0x02_00 | UInt16(replacement))
  }
...
extension ASCIIMappingEntry: Equatable {

  @inlinable
  internal static func == (lhs: ASCIIMappingEntry, rhs: ASCIIMappingEntry) -> Bool {
...
///
@usableFromInline
internal struct UnicodeMappingEntry {
